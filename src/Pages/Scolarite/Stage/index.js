...
const CrudTable = () => {
  ...
  const columns = [
    ...
    {
      title: <Text strong style={{ fontSize: '16px' }}>Prenom de l'etudiant</Text>,
...
>
  ...
  const EditUserForm = () => {
    ...
    const getInitialValues = () => {
      ...
      initialValues.DateDebut = dayjs(initialValues.DateDebut);
      initialValues.DateFin = dayjs(initialValues.DateFin);
